...
## Purpose
This document deepens the repository-specific architecture story for **Seppmail-API-PowerShell**.

## Core focus
PowerShell module patterns for authenticated SEPPmail API automation
